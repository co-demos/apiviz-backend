          ...
          "extra_buttons" : [ ### for buttons not declared in routes/pages
            ...
            { "is_visible" : True,
              ...
              "dropdowns"  : [
                ...
                { "is_divider" : True,  "is_external_link" : False },
                { "is_divider" : False, "is_external_link" : False, "link_to" : "/selection-diy", "link_text" : [{"locale" : "en", "text" : "DIY materials selection"},{"locale" : "es", "text" : "Seleccion DIY"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Sélection de matériels DIY"}] },
                { "is_divider" : True,  "is_external_link" : False },
            ...
            { "is_visible" : True,
              ...
              "dropdowns"  : [
                ...
                { "is_divider" : True,  "is_external_link" : False },
                { "is_divider" : False, "is_external_link" : False, "link_to" : "/selection-initiatives", "link_text" : [{"locale" : "en", "text" : "Initiatives selection"},{"locale" : "es", "text" : "Seleccion de iniciativas"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Sélection d'initiatives'"}] },
                { "is_divider" : True,  "is_external_link" : False },
