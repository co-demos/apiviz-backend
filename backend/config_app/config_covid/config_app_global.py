  ...
  ### CONFIG PING CARTO
    ...
    ### LANGUAGES
      ...
      { "field"       : "app_basic_dict",
        ...
        "dowload_file"   : [{"locale" : "en", "text" : "Download the design"},{"locale" : "es", "text" : "Descargar el diseño"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Télécharger le design" }],
