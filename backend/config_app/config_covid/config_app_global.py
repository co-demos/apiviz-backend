  ...
  ### CONFIG PING CARTO
    ...
    ### LANGUAGES
      ...
      { "field"       : "app_basic_dict",
        ...
        "source"         : [{"locale" : "en", "text" : "Source"},{"locale" : "es", "text" : "Fuente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Source" }],
        "back_to_results": [{"locale" : "en", "text" : "Back to results"},{"locale" : "es", "text" : "Regresar a los resultados"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Retour aux résultats de recherche" }],
        "see_website"    : [{"locale" : "en", "text" : "Check the website"},{"locale" : "es", "text" : "Ver el sitio"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Aller sur le site" }],
        "see_contact"    : [{"locale" : "en", "text" : "See the contact"},{"locale" : "es", "text" : "Ver contacto"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Contact" }],
        "share_link"     : [{"locale" : "en", "text" : "Share this link"},{"locale" : "es", "text" : "Compartir el enlace"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Partagez ce lieu" }],
        "infos"          : [{"locale" : "en", "text" : "Infos"},{"locale" : "es", "text" : "Infos"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Informations pratiques" }],
        "open_infos"     : [{"locale" : "en", "text" : "Schedule"},{"locale" : "es", "text" : "Horario"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Horaires" }],
        "more_infos"     : [{"locale" : "en", "text" : "More infos"},{"locale" : "es", "text" : "Mas infos"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Autres informations" }],
        ...
        "tel"            : [{"locale" : "en", "text" : "Phone"},{"locale" : "es", "text" : "Telefono"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Téléphone" }],
        ...
        "services"       : [{"locale" : "en", "text" : "Services"},{"locale" : "es", "text" : "Servicios"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Services proposés" }],
        "dowload_file"   : [{"locale" : "en", "text" : "Download document"},{"locale" : "es", "text" : "Descargar el documento"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Télécharger le document" }],
