    ...
    ### - - - - - - - - - - - - - - - ###
        ...
        "filter_options" : [
          ...
          {	"name"		: u"code_thematique__",  
            ...
            "choices"	: [
              ...
              {'name' : u'URB', 'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Urbanisme & aménagement' }]},
            ],
          },
      ...
      { "field"         : "tl_data_API_map",
        ...
        "args_options"  : [
          ...
          {  "app_arg" : "defaultValue", "arg" : "fields_to_return",  "optional" : False, "in" : ["url"], "default" : "result_context,DEPARTEMENT,slug",  "type": "str" },
