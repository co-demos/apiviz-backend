    ...
    ### - - - - - - - - - - - - - - - ###
      ...
      { "field"         : "tl_data_API_filters",
        ...
        "filter_options" : [
          ...
          {	"name"		: u"code_access__",  
            "id"      : "filter_2",
            "col_name" : "code_access",
            "dataType" : "text",
            ...
            "choices"	: [
              ...
              {'name' : u'D', 'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'Renovar el trabajo'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Lieux de formation' }]},
              {'name' : u'A', 'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'Renovar el trabajo'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Lieux de médiation et de fabrication' }]},
            ],
          },
          ...
          {	"name"		: u"code_label__",  
            ...
            "choices"	: [
              ...
              {'name' : u'F',    'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'FabLab' }]},
              {'name' : u'FO',   'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'FabLab solidaire Orange' }]},
              {'name' : u'TL',   'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'France Tiers Lieux' }]},
              ...
              {'name' : u'P',    'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'PANDA' }]},
              ...
              {'name' : u'BFC',  'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Signataire de la charte des tiers lieux' }]},
            ],
          },
          ...
          {	"name"		: u"code_accomp__",  
            ...
            "choices"	: [
              ...
              {'name' : u'I', 'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Accompagnement individuel sur rendez-vous' }]},
