...
for folder in config_folders : 
  ...
  default_data_endpoints_config = default_data_endpoints_config + temp_config_list
  print
print ("... -> default_data_endpoints_config : ", default_data_endpoints_config)


default_data_endpoints_config_ = [
