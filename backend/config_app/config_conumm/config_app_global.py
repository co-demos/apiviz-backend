  ...
  ### CONFIG CONUMM
    ...
    ### LOGO
      { "field"       : "app_logo",
        ...
        "url"           : "https://raw.githubusercontent.com/co-demos/PING-carto/master/logos/hubCONUMM/LogoCONUMM_couleurs_light.png",
    ...
    ### METAS
      { "field"       : "app_title",
        ...
        "content"      : u"CONUMM",
        "content_text" : [{"locale" : "en", "text" : "Mapping"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Espaces de médiation numérique en Pays de la Loire"}],
        "content_size" : 7,
        "is_in_navbar" : True,
        # "title_color" : "primary",
