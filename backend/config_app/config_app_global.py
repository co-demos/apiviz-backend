  ...
  ### CONFIG SONUM 
    ...
    ### LANGUAGES
      ...
      { "field"       : "app_basic_dict",
        ...
        "reinit_filters" : [{"locale" : "en", "text" : "delete filterrs"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Supprimer tous les filtrees" }],
    ...
    ### GLOBAL CONTENTS / TEXTS
      { "field"       : "app_welcome",
        ...
        "content"     : [{"locale" : "en", "text" : "welcome"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Bienvenue"}],
    ...
    ### REPO GITHUB
      { "field"       : "app_code",
        ...
        "content"     : [{"locale" : "en", "text" : "Source code"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Code source"}],
        "in_navbar"   : False,
        "in_footer"   : True,
