  ...
  ### CONFIG PING CARTO 
    ...
    ### - - - - - - - - - - - - - - - ###
      ...
      { "field"         : "tl_data_API_filters",
        ...
        "items_found"   : [
          {"locale" : "en", "text" : "results found"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "résultats trouvés" }
        ],
        "stats_text"   : [
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/infos/get_one/61a4f215328ed7643f18e736",  
        "args_options"  : [
        ...
        "filter_options" : [
          ...
          {	"name"		: u"DEP__",  
            ...
            "col_name" : "DEP",
            "dataType" : "text",
            "filter_title" : [{"locale" : "en", "text" : "Departement"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Departement" }],
            "choices"	: [
              {'name' : u'14', 'choice_title' : [{'locale' : 'en', 'text' : 'to do'},{'locale' : 'es', 'text' : 'to do'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : '14' }]},
            ],
          },
          ...
          #     {'name' : u'Sport', 'choice_title' : [{'locale' : 'en', 'text' : 'to do'},{'locale' : 'es', 'text' : 'to do'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Sport' }]},
      ...
      { "field"         : "tl_data_API_table",
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/infos/get_one/61a4f215328ed7643f18e736", ## V2
        "args_options"  : [
          {  "app_arg" : "dataToken",        "arg" : "token",            "optional" : True, "in" : ["url","header"],  "default" : "", "type": "str" },
      ...
      { "field"         : "tl_data_API_stats",
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/infos/get_one_stats/61a4f215328ed7643f18e736", ## V2
      ...
      { "field"         : "tl_data_API_map",
        ...
        "args_options"  : [
          ...
          {  "app_arg" : "defaultValue", "arg" : "fields_to_return",  "optional" : False, "in" : ["url"], "default" : "libgeo,LIBEPCI",  "type": "str" },
      ...
      { "field"         : "tl_data_API_export",
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/exports/as_csv/61a4f215328ed7643f18e736", ## V2
        "args_options"  : [
          {  "app_arg" : "dataToken",  "arg" : "token",            "optional" : True, "in" : ["url","header"],  "default" : "", "type": "str" },
