  ...
  ### CONFIG PING CARTO
    ...
    ### LANGUAGES
      ...
      { "field"       : "app_basic_dict",
        ...
        "infos"          : [{"locale" : "en", "text" : "Infos"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Informations" }],
        "open_infos"     : [{"locale" : "en", "text" : "Infos"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Indicateurs" }],
    ...
    ### LOGO
      { "field"       : "app_logo",
        ...
        # "url"         : "http://localhost:8800/statics/logos/Logo_v1.png",
        "url"           : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/logos/Logo_v1.png",
        "app_version" : version,
    ...
    ### METAS
      { "field"       : "app_title",
        ...
        "image_preview" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/documentation/screenshots/map-view-tiers-lieux-01.png",

        "content"      : u"Carto PDVPLV",
        "content_text" : [{"locale" : "en", "text" : "PDVPLV"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "pas de vacance pour la vacance"}],
        "content_size" : 7,
        "is_in_navbar" : True,
        # "title_color" : "primary",
      ...
      { "field"       : "app_keywords",
        ...
        "content"     : u"""dataviz,data visualisation,data visualization,SIG,commons,digital commons,API,opensource,open source,open data,opendata,MIT licence,github,sJS,javascript,python,flask,HTML,CSS,JSON,bulma,Vue.js,co-demos, codemos""",
        "apiviz_front_uuid" : uuid_models["uuid_pdvplv"],
        "is_default"  : True
      },
