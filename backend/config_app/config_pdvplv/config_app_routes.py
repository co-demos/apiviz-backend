  ...
  ### - - - - - - - - - - - - - - - - - - -  ###
    ...
    ### - - - - - - - - - - - - - - - - - ###
      ...
      { "field"             : "app_home_fr",
        ...
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/home.html" },
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/home.html" },
    ...
    ### - - - - - - - - - - - - - - - - - ###
      ...
      { "field"             : "tl_carte",
        ...
        "map_options"   : {
          ...
          "subdomains"       : 'abcd',
          "center"           : [49.182863, -0.370679],
          "currentCenter"    : [49.182863, -0.370679],
          "zoom"             : 10,
          "maxZoom"          : 18,
          "minZoom"          : 2,
          ...
          "mapbox_layers" : {
            ...
            "all_points_layer" : {
              ...
              "popup_config"        : {
                "action" : 'mousemove',
                "fields" : [
                  { 'position' : 'field_main_title', 'field' : 'libgeo', 'prefix' : None, 'suffix' : None, 'class': 'is-size-6 has-text-weight-semibold' },
      ...
      { "field"             : "tl_table",
        ...
        "contents_fields"  : [
          ...
          #   "position"    : "col_3",
          #   "is_sortable" : False,
          #   "custom_title" : [ { "locale" : "fr", "text" : "tags" }],
          #   "is_tag_like" : True,
          #   "tags_separator" : "-",
          #   "text_color" : "white",
          #   "background_color" : "primary",
          #   "convert_from_filters" : False, # uses "field" to match with "filter_options.col_name"
          # },
      ...
      { "field"             : "tl_detail",
        ...
        "contents_fields"  : [
          ...
          #   "text_color" : "white",
          #   "background_color" : "primary",
          #   "custom_title" : [ { "locale" : "fr", "text" : "Organisation(s) :" } ],
          #   "convert_from_filters" : False, # uses "field" to match with "filter_options.col_name"
          # },
          # { "field"       : "platform",
          #   "field_format" : { "trim" : None, "type" : "object", "retrieve" : [0] },
          ...
          #   "text_color" : "white",
          #   "background_color" : "primary",
          #   "custom_title" : [ { "locale" : "fr", "text" : "Plateforme(s) :" } ],
          #   "convert_from_filters" : True, # uses "field" to match with "filter_options.col_name"
          # },
          # { "field"       : "tags",
          #   "field_format" : { "trim" : None, "type" : "object", "retrieve" : [0] },
          ...
          #   "text_color" : "white",
          #   "background_color" : "primary",
          #   "custom_title" : [ { "locale" : "fr", "text" : "Tag(s) :" } ],
          #   "convert_from_filters" : True, # uses "field" to match with "filter_options.col_name"
          # },
          # { "field"       : "type",
          #   "field_format" : { "trim" : None, "type" : "object", "retrieve" : [0] },
          ...
          #   "text_color" : "white",
          #   "background_color" : "primary",
          #   "custom_title" : [ { "locale" : "fr", "text" : "Type(s) :" } ],
          #   "convert_from_filters" : True, # uses "field" to match with "filter_options.col_name"
          # },
          # { "field"       : "PUBLICS",
          #   "field_format" : { "trim" : None, "type" : "object", "retrieve" : [0] },
    ...
    ### - - - - - - - - - - - - - - - - - ###
      ...
      { "field"             : "tl_demarche",
        ...
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/la-demarche.html" },
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/la-demarche.html" },
      ...
      { "field"             : "tl_contribuer",
        ...
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/contribuer.html" },
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/contribuer.html" },
      ...
      { "field"             : "tl_legal",
        ...
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/mentions-legales-fr.html" },
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/PDVPLV-carto/master/pages-html/mentions-legales-fr.html" },
