    ...
    ### - - - - - - - - - - - - - - - ###
        ...
        "filter_options" : [
          ...
          {	"name"		: u"TYPE_STRUCTURE__",
            ...
            "choices"	: [
              ...
              {'name' : u'cms', 'choice_title' : [{'locale' : 'en', 'text' : 'to do'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'yapılmamış'},{'locale' : 'de', 'text' : 'ungemacht'}, {'locale' : 'fr', 'text' : "CMS" }]},              # {'name' : u'tiers_lieux', 'choice_title' : [{'locale' : 'en', 'text' : 'to do'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'yapılmamış'},{'locale' : 'de', 'text' : 'ungemacht'}, {'locale' : 'fr', 'text' : "tiers_lieux" }]},
              ...
              {'name' : u'msap_mfs', 'choice_title' : [{'locale' : 'en', 'text' : 'to do'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'yapılmamış'},{'locale' : 'de', 'text' : 'ungemacht'}, {'locale' : 'fr', 'text' : "MSAP / MFS" }]},
              # {'name' : u'association', 'choice_title' : [{'locale' : 'en', 'text' : 'to do'},{'locale' : 'es', 'text' : 'pendiente'},{'locale' : 'tr', 'text' : 'yapılmamış'},{'locale' : 'de', 'text' : 'ungemacht'}, {'locale' : 'fr', 'text' : "association" }]},
          ...
          {	"name"		: u"TAGS__",  
            ...
            "choices"	: [
              ...
              {'name' : u'itinerance',  'choice_title' : [{'locale' : 'en', 'text' : 'todo'},{'locale' : 'es', 'text' : 'Renovar el trabajo'},{'locale' : 'tr', 'text' : 'to do'},{'locale' : 'de', 'text' : 'to do'}, {'locale' : 'fr', 'text' : 'Itinérance' }]},
      ...
      { "field"         : "tl_data_API_map",
        ...
        "args_options"  : [
          ...
          {  "app_arg" : "defaultValue", "arg" : "fields_to_return",  "optional" : False, "in" : ["url"], "default" : "COM_CODE,carto_id,NOM_DISPOSITIF,TAGS,TYPE_STRUCTURE,ADRESSE_COMPLETE",  "type": "str" },
