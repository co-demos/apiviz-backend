  ...
  ### CONFIG PING CARTO 
    ...
    ### - - - - - - - - - - - - - - - ###
      ...
      { "field"         : "ocf_data_API_filters",
        ...
        "placeholder"   : [
          {"locale" : "en", "text" : "Enter the name of a society"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Tapez le nom d'une société" }
        ],
        "items_found"   : [
          {"locale" : "en", "text" : "companies found"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "sociétés trouvées" }
        ],
        "stats_text"   : [
      ...
      { "field"         : "ocf_data_API_table",
        ...
        "resp_fields" : {
          ...
          "projects" : { "resp_format" : "list", "path" : "hydra:member" },
          # "projects" : { "resp_format" : "list", "path" : "" },

          "total" :    { "resp_format" : "int",  "path" : "hydra:totalItems" },
      ...
      { "field"         : "ocf_data_API_list",
        ...
        "request_header_options" : [
          { "header_field" : u"Accept",  "header_value" : "application/ld+json",   "is_var" : False, "app_var_name" : None,    "header_value_prefix" : None },
          # { "header_field" : u"Host",    "header_value" : "opencorporatefacts.fr", "is_var" : False, "app_var_name" : None,    "header_value_prefix" : None },
          # { "header_field" : u"Referer", "header_value" : "http://opencorporatefacts.fr/api/corporates?page=1", "is_var" : False, "app_var_name" : None,    "header_value_prefix" : None },
          # { "header_field" : u"Origin",  "header_value" : "http://opencorporatefacts.fr", "is_var" : False, "app_var_name" : None,    "header_value_prefix" : None },
          # { "header_field" : u"Content-type",  "header_value" : "application/ld+json", "is_var" : False, "app_var_name" : None,    "header_value_prefix" : None },
          # { "header_field" : u"Authorization", "header_value" : None,                  "is_var" : True,  "app_var_name" : "token", "header_value_prefix" : None },
        ],
