  ...
  ### CONFIG PING CARTO
    ...
    ### METAS
      { "field"       : "app_title",
        ...
        "content"      : u"Open Corporate Facts",
        "content_text" : [{"locale" : "en", "text" : "Open Corporate Facts"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Open Corporate Facts"}],
        "is_in_navbar" : True,
        # "title_color" : "primary",
