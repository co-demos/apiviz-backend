  ...
  ### CONFIG RHINOCC CARTO
    ...
    ### METAS
      { "field"       : "app_title",
        ...
        "content_text" : [{"locale" : "en", "text" : "A lookout at third places in Loire region"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Lieux d’inclusion numérique en Occitanie"}],
        "content_size" : 7,
        "is_in_navbar" : True,
        # "title_color" : "primary",
