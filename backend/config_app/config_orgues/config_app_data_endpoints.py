  ...
  ### CONFIG TIERS LIEUX 
    ...
    ### - - - - - - - - - - - - - - - ###
      ...
      { "field"         : "tl_data_API_filters",
        ...
        "items_found"   : [
          {"locale" : "en", "text" : "organons found"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "orgues trouvés" }
        ],
        "stats_text"   : [
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/infos/get_one/5ddb9f89328ed7526928512b", 
        "args_options"  : [
        ...
        "filter_options" : [
          ...
          {	"name"		: u"Info_edifice__",
            "id"      : "filter_1",
            "col_name" : "Info_edifice",
            "dataType" : "text",
            "filter_title" : [{"locale" : "en", "text" : "Edifice"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Type d'édifice" }],
            "choices"	: [
              {'name' : u'EDIFICE_STANDARD', 'choice_title' : [{'locale' : 'en', 'text' : 'EDIFICE_STANDARD'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'EDIFICE_STANDARD' }]},
              {'name' : u'EDIFICE_NON_STANDARD', 'choice_title' : [{'locale' : 'en', 'text' : 'EDIFICE_NON_STANDARD'},{'locale' : 'es', 'text' : 'Brest Métropole'},{'locale' : 'tr', 'text' : 'Brest Métropole'},{'locale' : 'de', 'text' : 'Brest Métropole'}, {'locale' : 'fr', 'text' : 'EDIFICE_NON_STANDARD' }]},
            ],
          },
          ...
          {	"name"		: u"Nom_region__",
            ...
            "col_name" : "Nom_region",
            "dataType" : "text",
            "filter_title" : [{"locale" : "en", "text" : "Region"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Région" }],
            "choices"	: [
              {'name' : u'Auvergne-Rhône-Alpes', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Auvergne-Rhône-Alpes' }]},
              {'name' : u'Bourgogne-Franche-Comté', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Bourgogne-Franche-Comté' }]},
              {'name' : u'Bretagne', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Bretagne' }]},
              {'name' : u'Centre-Val de Loire', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Centre-Val de Loire' }]},
              {'name' : u'Corse', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Corse' }]},
              {'name' : u'Grand Est', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Grand Est' }]},
              {'name' : u'Guadeloupe', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Guadeloupe' }]},
              {'name' : u'Guyane', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Guyane' }]},
              {'name' : u'Hauts-de-France', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Hauts-de-France' }]},
              {'name' : u'Île-de-France', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Île-de-France' }]},
              {'name' : u'La Réunion', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'La Réunion' }]},
              {'name' : u'Martinique', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Martinique' }]},
              {'name' : u'Normandie', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Normandie' }]},
              {'name' : u'Nouvelle-Aquitaine', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Nouvelle-Aquitaine' }]},
              {'name' : u'Nouvelle-Calédonie', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Nouvelle-Calédonie' }]},
              {'name' : u'Occitanie', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Occitanie' }]},
              {'name' : u'Pays de la Loire', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Pays de la Loire' }]},
              {'name' : u"Provence-Alpes-Côte d'Azur", 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : "Provence-Alpes-Côte d'Azur" }]},
              {'name' : u'Saint-Pierre-et-Miquelon', 'choice_title' : [{'locale' : 'en', 'text' : 'Bordeaux Métropole'},{'locale' : 'es', 'text' : 'Bordeaux Métropole'},{'locale' : 'tr', 'text' : 'Bordeaux Métropole'},{'locale' : 'de', 'text' : 'Bordeaux Métropole'}, {'locale' : 'fr', 'text' : 'Saint-Pierre-et-Miquelon' }]},
            ],
          },
      ...
      { "field"         : "tl_data_API_table",
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/infos/get_one/5ddb9f89328ed7526928512b", ## V2
        "args_options"  : [
          {  "app_arg" : "dataToken",        "arg" : "token",            "optional" : True, "in" : ["url","header"],  "default" : "", "type": "str" },
          ...
          {  "app_arg" : "sortBy",           "arg" : "sort_by",          "optional" : True, "in" : ["url"],           "default" : "Edifice", "type": "str" },
      ...
      { "field"         : "tl_data_API_stats",
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/infos/get_one_stats/5ddb9f89328ed7526928512b", ## V2
      ...
      { "field"         : "tl_data_API_export",
        ...
        "root_url"      : "https://solidata-api.co-demos.com/api/dsi/exports/as_csv/5ddb9f89328ed7526928512b", ## V2
        "args_options"  : [
          {  "app_arg" : "dataToken",  "arg" : "token",            "optional" : True, "in" : ["url","header"],  "default" : "", "type": "str" },
