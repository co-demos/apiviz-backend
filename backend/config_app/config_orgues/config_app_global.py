  ...
  ### CONFIG TIERS LIEUX
    ...
    ### METAS
      ...
      { "field"       : "app_keywords",
        ...
        "content"     : u"""dataviz,data visualisation,data visualization,SIG,commons,digital commons,API,opensource,open source,open data,opendata,MIT licence,github,sJS,javascript,python,flask,HTML,CSS,JSON,bulma,Vue.js,Etalab,co-demos, codemos""",
        "apiviz_front_uuid" : uuid_models["uuid_orgues"],
        "is_default"  : True
      },
