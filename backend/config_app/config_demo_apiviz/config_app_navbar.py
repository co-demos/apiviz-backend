          ...
          "extra_buttons" : [ ### for buttons not declared in routes/pages
            ...
            { "is_visible" : True,
              ...
              "dropdowns"  : [
                ...
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://covid-initiatives.org/",             "link_text" : [{"locale" : "en", "text" : "Covid-initiatives"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Covid-initiatives"}] },
                { "is_divider" : True,  "is_external_link" : False },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://tierslieux.cartes.pingbase.net/",    "link_text" : [{"locale" : "en", "text" : "PiNG carto"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Carto Ping"}] },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://bfc-carto.netlify.app/",             "link_text" : [{"locale" : "en", "text" : "PiNG carto"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Carto Ternum"}] },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://tiers-lieux-dataviz.netlify.com/",   "link_text" : [{"locale" : "en", "text" : "Third places"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "France Tiers lieux"}] },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://decider-ensemble.netlify.app/",      "link_text" : [{"locale" : "en", "text" : "PiNG carto"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Ressources Décider Ensemble"}] },
                { "is_divider" : True,  "is_external_link" : False },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://etalab-codes.netlify.app/a-propos",  "link_text" : [{"locale" : "en", "text" : "Etalab codes"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Codes Etalab"}] },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://orgues-apiviz.netlify.app/",         "link_text" : [{"locale" : "en", "text" : "Organons"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Inventaire des orgues"}] },
                { "is_divider" : False, "is_external_link" : True, "link_to" : "https://apiviz-preprod-sonum.netlify.app/",  "link_text" : [{"locale" : "en", "text" : "Sonum"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "Carto Sonum"}] },
                { "is_divider" : True,  "is_external_link" : False },
