  ...
  ### - - - - - - - - - - - - - - - - - - -  ###
    ...
    ### - - - - - - - - - - - - - - - - - ###
      ...
      ### DATASETS CARTO SONUM
        ...
        { "field"             : "sonum_carto_liste",
          ...
          "in_footer"         : False,
          "urls"              : ["/mediation", "/mediation/liste"],
          # "template_url"      : "/static/spa.html",
          "template_urls"     : [
          ],
        ...
        { "field"             : "sonum_carto_detail",
          ...
          "in_footer"         : False,
          "urls"              : [ "/sonum-carto/detail", "/mediation/detail" ],
          # "template_url"      : "/static/spa.html",
          "template_urls"     : [
          ],
        ...
        { "field"             : "sonum_carto_calendar",
          ...
          "languages"         : ["fr"],
          "app_version"       : version,
          "comment"           : u"Main calendar route in french",
          "is_dynamic"        : True,
          "dataset_uri"       : "mediation",
          "dynamic_template"  : 'DynamicCalendar',
      ...
      ### DATASETS TIERS LIEUX
        ...
        { "field"             : "tl_carte",
          ...
          "in_footer"         : False,
          "urls"              : [ "/tiers-lieux", "/tiers-lieux/carte"],
    ...
    ### - - - - - - - - - - - - - - - - - ###
      ...
      { "field"             : "tl_lexicon",
        ...
        "in_footer"         : False,
        "link_in_logo"      : True,
        "urls"              : ["/digital-lexicon"],
        "dataset_uri"       : "galery",
        
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/apiviz-website-demo/master/pages-html/apiviz-lexique-num.html" }, 
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/apiviz-website-demo/master/pages-html/apiviz-lexique-num.html" }, 
          # { "locale" : "fr", "url" : "http://localhost:8800/html/pages-html/apiviz-lexique-num.html" }, 
          # { "locale" : "en", "url" : "http://localhost:8800/html/pages-html/apiviz-lexique-num.html" }, 
        ],
      ...
      { "field"             : "tl_ressources",
        ...
        "in_footer"         : False,
        "link_in_logo"      : True,
        "urls"              : ["/ressources-opendata"],
        "dataset_uri"       : "mediation",
        
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/apiviz-website-demo/master/pages-html/ressources-opendata-fr.html" }, 
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/apiviz-website-demo/master/pages-html/ressources-opendata-en.html" }, 
          # { "locale" : "fr", "url" : "http://localhost:8800/html/pages-html/ressources-opendata-fr.html" }, 
          # { "locale" : "en", "url" : "http://localhost:8800/html/pages-html/ressources-opendata-en.html" }, 
        ],
      ...
      { "field"             : "tl_legal",
        ...
        "template_urls"     : [
          { "locale" : "fr", "url" : "https://raw.githubusercontent.com/co-demos/apiviz-website-demo/master/pages-html/mentions-legales-fr.html" }, 
          { "locale" : "en", "url" : "https://raw.githubusercontent.com/co-demos/apiviz-website-demo/master/pages-html/mentions-legales-fr.html" }, 
