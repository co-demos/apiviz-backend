  ...
  ### CONFIG PING CARTO
    ...
    ### LOGO
      { "field"       : "app_logo",
        ...
        # "url"         : "http://localhost:8800/statics/logos/cropped-profil-gpe-observatoire-192x192.png",
        "url"           : "https://raw.githubusercontent.com/co-demos/ODF-carto/master/logos/cropped-profil-gpe-observatoire-192x192.png",
        "app_version" : version,
    ...
    ### METAS
      { "field"       : "app_title",
        ...
        "content_text" : [{"locale" : "en", "text" : "A lookout at third places in Loire region"},{"locale" : "es", "text" : "pendiente"},{"locale" : "tr", "text" : "yapılmamış"},{"locale" : "de", "text" : "ungemacht"}, {"locale" : "fr", "text" : "carto Observatoire open data"}],
        "content_size" : 7,
        "is_in_navbar" : True,
        # "title_color" : "primary",
